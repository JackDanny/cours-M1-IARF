...
//    if (!loader->load("../data/elephant.obj", reason))
    ...
    */
    ...
    ParametricMesh* obj = new ParametricSphere();

    //Geodesique *obj = new Geodesique();
       obj->generateMesh(50,50);
       ...
       GlMaterial *mapMaterial = new GlMaterial(glm::vec3(0.6f, 0.8f, 0.8f), glm::vec3(1.0f, 1.0f, 1.0f), 25.f);
       Texture *mapTex = new Texture("../data/EarthMap.jpg");
       mapMaterial->setTexture(mapTex);

       GlEntity *entity = new GlEntity(mesh_plane,mapMaterial,theTransformation);
