...
Press the WATCH ONE-OF TURTLES and FOLLOW ONE-OF TURTLES buttons to focus on the behavior of one specific termite and the area directly surrounding it. Notice that the selected termite is displayed in the SUBJECT monitor. While watching or following a termite you can study its behavior in another way by pressing the SUBJECT PD button.  This leaves a trail behind the subject so you can see where its been. Press the RESET-PERSPECTIVE button to return to the broad view of the world.
...
- Wilensky, U. (1997).  NetLogo Termites (Perspective Demo) model.  http://ccl.northwestern.edu/netlogo/models/Termites(PerspectiveDemo).  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
- Wilensky, U. (1999). NetLogo. http://ccl.northwestern.edu/netlogo/. Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.

In other publications, please use:
- Copyright 1997 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/Termites(PerspectiveDemo) for terms of use.
