...
Put the subject's pen down to trace its path. Put all the pens down and study the behavior of all the ants at a high level.
...
- Wilensky, U. (1998).  NetLogo Ants (Perspective Demo) model.  http://ccl.northwestern.edu/netlogo/models/Ants(PerspectiveDemo).  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
- Wilensky, U. (1999). NetLogo. http://ccl.northwestern.edu/netlogo/. Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.

In other publications, please use:
- Copyright 1998 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/Ants(PerspectiveDemo) for terms of use.
...
This model was developed at the MIT Media Lab using CM StarLogo.  See Resnick, M. (1994) "Turtles, Termites and Traffic Jams: Explorations in Massively Parallel Microworlds."  Cambridge, MA: MIT Press.  Adapted to StarLogoT, 1998, as part of the Connected Mathematics Project.
