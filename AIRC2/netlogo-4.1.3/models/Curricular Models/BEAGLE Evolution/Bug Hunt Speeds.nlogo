...
to update-plots
  ...
  set-current-plot "Bugs Caught"
  clear-plot

  set-histogram-num-bars 8
  set-current-plot-pen "pen1"
  plotxy 1 total-speed-1-caught
...
- Copyright 2005 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/BugHuntSpeeds for terms of use.
