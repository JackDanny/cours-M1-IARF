...
to do-plotting
  ...
  ;;set-current-plot "Avg. Wall Hits per Particle"
  ;;if clock > 1
  ;;  [ plotxy clock wall-hits-per-particle ]
end
...
- Copyright 2004 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/ConnectedChemistry2ChangingPressure for terms of use.
