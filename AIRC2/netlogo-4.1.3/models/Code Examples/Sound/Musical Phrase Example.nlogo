...
WHAT IS IT?
-----------
This code example shows how PLAY-NOTE-LATER can be used to play a musical phrase without using START-NOTE and STOP-NOTE.  This allows the model to continue running while the musical phrase plays.


HOW IT WORKS
------------
The model uses PLAY-NOTE-LATER with an increasing delay value to construct the musical phrase.
