...
WHAT IS IT?
-----------
Composer is a toy model that lets you write songs and play them using the NetLogo sound extension.
...
EXTENDING THE MODEL
-------------------
Add eighth notes.  Add sharps and flats.  Support several instruments at once.
@#$#@#$#@
default
true
0
