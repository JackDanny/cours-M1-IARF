...
WHAT IS IT?
-----------
Here's a drum machine made with NetLogo.  It uses the sound extension.  You can make your own beats with it.  Beats can be saved to disk and then loaded back in later.
...
NETLOGO FEATURES
----------------
For more information on the sound extension, and on NetLogo's (new and experimental) extensions facility in general, see the "Sound" and "Extensions" sections of the NetLogo User Manual.
