...
Try importing an image with IMPORT-PCOLORS and then import the same image with IMPORT-DRAWING and IMPORT-COLORS-RGB.  How does handling of the image differ?
@#$#@#$#@
default
true
0
