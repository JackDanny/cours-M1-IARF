...
HOW IT WORKS
------------
Turtles who don't have a partner are gray and turtles who do are red.  Turtles without partners move randomly about the View until they land on a patch with another turtle without a partner.  When this happens, the two turtles form a partnership and stop moving.


RELATED MODELS
--------------
See "Grouping Turtles Example" to see how to form groups that contain more than two turtles.
@#$#@#$#@
default
true
0
