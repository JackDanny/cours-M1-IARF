to setup
  ...
  setup-plot           ; set the histogram's settings
  do-plot              ; so we have an initial histogram even before pressing "go"
end
...
to do-plot
  histogram [xcor] of turtles          ; using the default plot pen
end
