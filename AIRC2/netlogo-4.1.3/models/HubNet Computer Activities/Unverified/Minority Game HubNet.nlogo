...
to do-plot
  let score-list map [ [score] of ? ] sort turtles
  let success-list map [ [ score / choices-made ] of ? ] sort players with [ choices-made > 0 ]
  if ticks > 0
...
- Copyright 2004 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/HubNetMinorityGameHubNet for terms of use.
