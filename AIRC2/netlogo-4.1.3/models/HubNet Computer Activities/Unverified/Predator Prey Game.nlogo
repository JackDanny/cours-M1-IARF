...
- Wilensky, U. (2002).  NetLogo HubNet Predator Prey Game model.  http://ccl.northwestern.edu/netlogo/models/HubNetPredatorPreyGame.  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
- Wilensky, U. (1999). NetLogo. http://ccl.northwestern.edu/netlogo/. Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.

In other publications, please use:
- Copyright 2002 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/HubNetPredatorPreyGame for terms of use.
