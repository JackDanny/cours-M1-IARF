...
;; at this point you must tell the computer that you are using computer
;; clients and initialize the system.
to startup
  setup
...
to go
  ...
  every 0.1
  [
    ;; display (and tick) causes world updates messages to be sent to clients
