...
to go
  ...
  [ wiggle
    fd sheep-speed ]
  tick
  if ticks mod 50 = 0 [  ;; since the calculations are expensive
    update-sheep-counts
    calculate-herding-efficiency
    do-plot
  ]
...
false
PENS
"efficiency" 1.0 0 -13345367 true
...
- Copyright 1998 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/Shepherds for terms of use.
