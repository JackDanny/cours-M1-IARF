...
to go
  ...
  every 0.1 [ calculate-gene-metrics do-current-plots ]
end
...
to do-current-plots
  ...
  set-plot-pen-color black
   plotxy ticks total-caught
    ...
    set-current-plot "Vector difference in Average genotype"
  plotxy ticks vector-difference

 set-current-plot "Average HSB Values"
  set-current-plot-pen "hue"
   plotxy ticks mean [item 0 extract-hsb  approximate-rgb (item 0 color) (item 1 color) (item 2 color)] of bugs
   set-current-plot-pen "saturation"
   plotxy ticks mean [item 1 extract-hsb approximate-rgb (item 0 color) (item 1 color) (item 2 color)] of bugs
  set-current-plot-pen "brightness"
   plotxy ticks mean [item 2 extract-hsb approximate-rgb (item 0 color) (item 1 color) (item 2 color)] of bugs


  set-current-plot "Current Hues"
  ;;histogram [approximate-rgb (item 0 color) (item 1 color) (item 2 color)] of bugs
  ...
  set-current-plot "Current Saturations"
  ...
  set-current-plot "Current Brightnesses"
  histogram [item 2 extract-hsb approximate-rgb (item 0 color) (item 1 color) (item 2 color)] of bugs
  set max-number-of-brightness plot-y-max

  set-current-plot "Initial Hues"
  if max-number-of-hue > 5 [set-plot-y-range 0 max-number-of-hue]
  set-current-plot "Initial Saturations"
  if max-number-of-saturation > 5 [set-plot-y-range 0 max-number-of-saturation]
  set-current-plot "Initial Brightnesses"
  if max-number-of-brightness > 5 [set-plot-y-range 0 max-number-of-brightness]
...
true
PENS
"hue" 1.0 0 -16777216 true
"brightness" 1.0 0 -955883 true
"saturation" 1.0 0 -7500403 true
...
- Copyright 2005 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/BugHuntCamouflage for terms of use.
