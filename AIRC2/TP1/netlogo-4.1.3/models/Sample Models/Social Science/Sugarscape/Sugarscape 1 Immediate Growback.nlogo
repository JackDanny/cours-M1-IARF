...
THINGS TO TRY
-------------
Try varying the initial POPULATION. What effect does the initial POPULATION have on the final stable population?
Does it have an effect on the distribution of agent properties, such as vision and metabolism?
...
- Copyright 2009 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/Sugarscape1ImmediateGrowback for terms of use.
