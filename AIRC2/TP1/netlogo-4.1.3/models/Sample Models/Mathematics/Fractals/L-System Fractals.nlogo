...
THINGS TO TRY
-------------
Now that you have played around with settings for the examples provided, why not try making your own fractals.  You can do this by changing the commands in the applyRules procedure in the "Procedures" tab.  The comments in that procedure list the commands you can use.
...
- Copyright 2001 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/L-SystemFractals for terms of use.
