...
to update-plots
  ...
  set maxbar modes pair-outcomes
  set maxrange length filter [ ? = item 0 maxbar ] pair-outcomes
  set-plot-y-range 0 max list 51 maxrange
end
...
- Copyright 2005 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/DiceStalagmite for terms of use.
