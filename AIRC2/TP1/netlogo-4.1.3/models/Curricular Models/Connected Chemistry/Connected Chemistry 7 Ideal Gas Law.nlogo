...
to setup-plots
  set-current-plot "1: Volume vs. Time"
  plotxy ticks precision volume 0
end

to do-plotting
  set-current-plot "1: Pressure vs. Time"
 ...
 set-current-plot "1: Volume vs. Time"
  ...
  set-current-plot "1: Temperature vs. Time"
  plotxy ticks temperature

  set-current-plot "1: Number vs. Time"
  plotxy ticks total-particle-number
...
- Copyright 2005 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/ConnectedChemistry7IdealGasLaw for terms of use.
