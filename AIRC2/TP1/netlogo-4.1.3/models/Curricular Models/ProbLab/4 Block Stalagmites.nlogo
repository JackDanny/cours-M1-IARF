...
o      How many trials does it take for the experiment to produce an all-green 4-block?  How is this dependent on the various settings?
...
- Copyright 2006 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/4BlockStalagmites for terms of use.
