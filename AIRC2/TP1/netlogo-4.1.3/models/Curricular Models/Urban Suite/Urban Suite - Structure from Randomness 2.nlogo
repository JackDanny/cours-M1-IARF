...
to update-plots
  ...
  set-current-plot "Potential"
  set-current-plot-pen "max potential"
  plot max [potential] of patches
  set-current-plot-pen "avg potential x 10"
  plot (mean [potential] of patches) * 10
end
...
false
PENS
"max potential" 1.0 0 -10899396 true
"avg potential x 10" 1.0 0 -13345367 true
