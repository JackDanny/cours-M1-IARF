...
EXTENDING THE MODEL
-------------------
Improve the buttons the Interface tab that create and destroy halos to include sanity/safety checks.  The button that creates halos shouldn't put a halo on a turtle that already has one; the button that destroys halos shouldn't blow up if there are no halos left.
