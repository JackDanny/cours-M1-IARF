...
RELATED MODELS
--------------
As of NetLogo 2.1, this code is used in the Rugby model, in Sample Models under Mathematics.  (Older versions of Rugby didn't use it, and as a result generated slightly incorrect data.)
@#$#@#$#@
default
true
0
