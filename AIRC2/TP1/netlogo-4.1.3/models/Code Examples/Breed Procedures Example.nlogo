...
NETLOGO FEATURES
----------------
Since NetLogo 4.0, the RUN command is fast when you use it over and over again on the same strings, so using this technique won't hurt the performance of your model.
@#$#@#$#@
default
true
0
