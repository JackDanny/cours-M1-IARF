...
WHAT IS IT?
-----------
This model demonstrates the capabilities of the NetLogo Sound Extension. It allows modelers to experiment with different drums.

The instrument section allows you to choose one of the 47 drums provided by the sound extension. (For a complete list, see the Sound section of the NetLogo User Manual).
