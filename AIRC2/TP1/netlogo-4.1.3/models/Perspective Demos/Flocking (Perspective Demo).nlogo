...
Press the WATCH ONE-OF TURTLES and FOLLOW ONE-OF TURTLES buttons to focus on the behavior of one specific bird and the area directly surrounding it. Notice that the selected bird is displayed in the SUBJECT monitor and it changes its color to red. While watching or following a bird you can study its behavior in another way by pressing the SUBJECT PD button.  This leaves a trail behind the subject so you can see where its been. Press the RESET-PERSPECTIVE button to return to the broad view of the world.
...
Try using both the watch and follow perspectives in the 2D and the 3D views. In the 3D view zoom in and out while in follow mode.  Note that when you zoom all the way in you are in ride mode.

Put the subject's pen down to trace its path.

Follow one of the birds and slow the model down using the speed slider, see if you can notice birds making turns toward or away from other birds as the flocks shift.
...
What happens if you change the topology of the world to a box?
...
- Wilensky, U. (1998).  NetLogo Flocking (Perspective Demo) model.  http://ccl.northwestern.edu/netlogo/models/Flocking(PerspectiveDemo).  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
- Wilensky, U. (1999). NetLogo. http://ccl.northwestern.edu/netlogo/. Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.

In other publications, please use:
- Copyright 1998 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/Flocking(PerspectiveDemo) for terms of use.
