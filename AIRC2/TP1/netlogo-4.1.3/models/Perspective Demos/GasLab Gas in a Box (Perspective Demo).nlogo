...
This model simulates the behavior of gas particles in a closed box, or a container with a fixe volume.  The path of single particle is visualized by a gray colored trace of the particle's most recent positions.
...
Perspective Buttons:
Press the WATCH, FOLLOW, and RIDE TURTLE 0 buttons to focus on the behavior of that particular particle and the area directly surrounding it. Notice that particle 0 is displayed in the SUBJECT monitor. Press the RESET-PERSPECTIVE button to return to the broad view of the world.
...
Try using both the watch and follow perspectives in the 2D and the 3D views. In the 3D view zoom in and out while in follow mode.  Note that when you zoom all the way in you are in ride mode, also notice that ride and follow are the same in the 2D view.

How does this 2D view differ from a 3D view?
...
- Wilensky, U. (1997).  NetLogo GasLab Gas in a Box (Perspective Demo) model.  http://ccl.northwestern.edu/netlogo/models/GasLabGasinaBox(PerspectiveDemo).  Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.
- Wilensky, U. (1999). NetLogo. http://ccl.northwestern.edu/netlogo/. Center for Connected Learning and Computer-Based Modeling, Northwestern University, Evanston, IL.

In other publications, please use:
- Copyright 1997 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/GasLabGasinaBox(PerspectiveDemo) for terms of use.
