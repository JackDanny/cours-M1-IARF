...
def partitionData(pourcentage_appr):
    ...
    for i in range(int(len(aa)*pourcentage_appr/100.)):
    ...
    for i in range((int(len(aa)*pourcentage_appr/100.)),(int(len(aa)) ) ):
...
def apprentissage_data(learn_classes):
    liste_parametres_class_aa = apprentissage_loi_normale(learn_classes[0])
    liste_parametres_class_ee = apprentissage_loi_normale(learn_classes[1])
    liste_parametres_class_eh = apprentissage_loi_normale(learn_classes[2])
    liste_parametres_class_eu = apprentissage_loi_normale(learn_classes[3])
    liste_parametres_class_ii = apprentissage_loi_normale(learn_classes[4])
    liste_parametres_class_oe = apprentissage_loi_normale(learn_classes[5])
    liste_parametres_class_oh = apprentissage_loi_normale(learn_classes[6])
    liste_parametres_class_oo = apprentissage_loi_normale(learn_classes[7])
    liste_parametres_class_uu = apprentissage_loi_normale(learn_classes[8])
    liste_parametres_class_yy = apprentissage_loi_normale(learn_classes[9])
    ...
    return liste_parametres_classes
...
(learn_classes,test_classes) = partitionData(pourcentage_appr)

#print("learn_classes =\n" + str(learn_classes))


#apprentissage des lois normales
'''
liste_parametres_class_aa = apprentissage_loi_normale(learn_classes[0])
liste_parametres_class_ee = apprentissage_loi_normale(learn_classes[1])
liste_parametres_class_eh = apprentissage_loi_normale(learn_classes[2])
...
liste_parametres_classes=apprentissage_data(learn_classes)
print("liste param=\n" + str(liste_parametres_classes))

print("test classes=\n" + str(test_classes))
close('all')

#cet affichage n'a de sens que si les points sont en dimenssion 2
...
#calcul des matrices de confusion pour kppv et loi normales
